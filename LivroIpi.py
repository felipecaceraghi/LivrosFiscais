...
SQL_TEMPLATES = {
    ...
    "56": "SELECT G.NOME_EMP FROM BETHADBA.GEEMPRE G WHERE G.CODI_EMP = ?",
    "57": "SELECT G.IEST_EMP FROM BETHADBA.GEEMPRE G WHERE G.CODI_EMP = ?",
    "53": """
...
def get_params_for_query(query_id, codi_emp, data_inicial, data_final):
    ...
    params_map = {"23": (codi_emp,), "56": (codi_emp,), "57": (codi_emp,),
